...
#End Region
    ...
    Private Sub SaveSettings()
        With My.Settings
            .SourceDirectory = txt_SourceDirectory.Text
            .WordTemplateFile = txt_WordTemplateFile.Text
            .ExcelTemplateFile = txt_ExcelTemplateFile.Text
            .OutputDirectory = txt_OutputDirectory.Text
            .ConvertedFilePrefix = txt_StartAtRecordNumber.Text
            .PreserveOriginalMarginSizes = chk_PreserveOriginalMargins.Checked
            .PreserveOriginalFileDates = chk_PreserveOriginalFileDates.Checked
            .PreserveOriginalFolderStructure = chk_PreserveOriginalFolderStructure.Checked
            .PreserveOriginalCustomProperties = chk_PreserveOriginalCustomProperties.Checked
            .Save()
        End With
    End Sub
    ...
    Private Sub LoadSettings()
        With My.Settings
            chk_PreserveOriginalMargins.Checked = .PreserveOriginalMarginSizes
            chk_PreserveOriginalFileDates.Checked = .PreserveOriginalFileDates
            chk_PreserveOriginalFolderStructure.Checked = .PreserveOriginalFolderStructure
            chk_PreserveOriginalCustomProperties.Checked = .PreserveOriginalCustomProperties
            txt_SourceDirectory.Text = .SourceDirectory
            txt_WordTemplateFile.Text = .WordTemplateFile
            txt_ExcelTemplateFile.Text = .ExcelTemplateFile
            txt_OutputDirectory.Text = .OutputDirectory
            txt_ConvertedFilePrefix.Text = .ConvertedFilePrefix
        End With
        ...
        If chk_SaveLogToFile.Checked Then
            If txt_OutputDirectory.Text <> "" Then
                ...
                Try
                    ...
                    End If
                Catch ex As Exception
                    MessageBox.Show(String.Format("The previous output directory ({0}) was invalid.{1}Please provide a valid path.", txt_OutputDirectory.Text, Environment.NewLine), "Invalid Output Directory")
    ...
    Private Sub ActivateProductLicenseToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ActivateProductLicenseToolStripMenuItem.Click
        Dim frmActivate As New frm_Activate
        frmActivate.Show()
    End Sub
